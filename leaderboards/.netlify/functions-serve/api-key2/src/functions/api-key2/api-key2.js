...
// functions/api-key2/api-key2.js
var api_key2_exports = {};
__export(api_key2_exports, {
  handler: () => handler
});
...
var handler = async (event) => {
  ...
  try {
    const { data } = await import_axios.default.get(urlTag);
    return {
      statusCode: 200,
...
module.exports = __toCommonJS(api_key2_exports);
 ...
 * MIT Licensed
 */
//# sourceMappingURL=api-key2.js.map
