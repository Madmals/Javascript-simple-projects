...
// functions/api-key1/api-key1.js
var api_key1_exports = {};
__export(api_key1_exports, {
  handler: () => handler
});
...
var handler = async (event) => {
  ...
  try {
    const { data } = await import_axios.default.get(urlTrending);
    return {
      statusCode: 200,
...
module.exports = __toCommonJS(api_key1_exports);
 ...
 * MIT Licensed
 */
//# sourceMappingURL=api-key1.js.map
